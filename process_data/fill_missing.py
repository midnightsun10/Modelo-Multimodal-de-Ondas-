...
def main():
    ...
    INPUT_DIR        = str(os.environ["INPUT"]) #"/home/brayan/DATA/Modelo-Multimodal-de-Ondas/raw_data/"
    OUTPUT_DIR       = str(os.environ["OUTPUT"]) #"/home/brayan/DATA/Modelo-Multimodal-de-Ondas/process/ASCAT/"
    date_update      = str(os.environ["CURRENT_DATE"]) #"2020-06-01"
    lag              = 30
